...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 6, 1, 85);
    			attr_dev(i, "class", "far fa-plus-square");
    			add_location(i, file$7, 8, 1, 191);
    			attr_dev(button, "type", "button");
    			attr_dev(button, "class", "nav-btn");
    			add_location(button, file$7, 7, 1, 131);
    			attr_dev(div, "class", "nav-center");
    			add_location(div, file$7, 5, 0, 59);
    			attr_dev(nav, "class", "nav");
    			add_location(nav, file$7, 4, 0, 41);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			t = text(/*title*/ ctx[0]);
    			add_location(h2, file$6, 5, 4, 85);
    			attr_dev(div, "class", "main-title");
    			add_location(div, file$6, 4, 0, 56);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 40, 6, 957);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$5, 32, 6, 690);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "name");
    			add_location(input0, file$5, 33, 6, 727);
    			attr_dev(div0, "class", "form-control");
    			add_location(div0, file$5, 31, 4, 657);
    			attr_dev(label1, "for", "amount");
    			add_location(label1, file$5, 36, 6, 825);
    			attr_dev(input1, "type", "number");
    			attr_dev(input1, "id", "amount");
    			add_location(input1, file$5, 37, 6, 866);
    			attr_dev(div1, "class", "form-control");
    			add_location(div1, file$5, 35, 4, 792);
    			attr_dev(button0, "type", "submit");
    			attr_dev(button0, "class", "btn btn-block");
    			button0.disabled = /*isEmpty*/ ctx[4];
    			toggle_class(button0, "disabled", /*isEmpty*/ ctx[4]);
    			add_location(button0, file$5, 42, 4, 1029);
    			attr_dev(i, "class", "fas fa-times");
    			add_location(i, file$5, 50, 6, 1270);
    			attr_dev(button1, "class", "close-btn");
    			add_location(button1, file$5, 49, 4, 1217);
    			attr_dev(form, "class", "expense-form");
    			add_location(form, file$5, 30, 2, 585);
    			attr_dev(section, "class", "form");
    			add_location(section, file$5, 28, 0, 528);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["addExpense", "editExpense", "isEditing", "hideForm", "name", "amount"];
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h4, file$4, 33, 6, 859);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i0, file$4, 28, 8, 712);
    			attr_dev(button0, "class", "amount-btn");
    			add_location(button0, file$4, 23, 6, 589);
    			add_location(h2, file$4, 20, 4, 479);
    			attr_dev(div0, "class", "expense-info");
    			add_location(div0, file$4, 19, 2, 448);
    			attr_dev(i1, "class", "fas fa-pen");
    			add_location(i1, file$4, 43, 6, 1275);
    			attr_dev(button1, "class", "expense-btn edit-btn");
    			add_location(button1, file$4, 40, 4, 1179);
    			attr_dev(i2, "class", "fas fa-trash");
    			add_location(i2, file$4, 47, 6, 1483);
    			attr_dev(button2, "class", "expense-btn delete-btn");
    			add_location(button2, file$4, 46, 4, 1402);
    			attr_dev(div1, "class", "expense-buttons");
    			add_location(div1, file$4, 39, 2, 1145);
    			attr_dev(article, "class", "single-expense");
    			add_location(article, file$4, 18, 0, 413);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/ExpensesList.svelte generated by Svelte v3.38.2 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h2 = element("h2");
    			h2.textContent = "you have not added any expenses";
    			attr_dev(h2, "class", "svelte-12asnrc");
    			add_location(h2, file$3, 22, 6, 526);
    		},
    		m: function mount(target, anchor) {
    ...
    // (18:4) {#each expenses as expense, index (expense.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file$3, 18, 6, 381);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!div_intro) div_intro = create_in_transition(div, fly, { x: 200, delay: /*index*/ ctx[3] * 500 });
    				div_intro.start();
    			});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:4) {#each expenses as expense, index (expense.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$3, 16, 2, 318);
    			add_location(section, file$3, 14, 0, 273);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ fly, flip, Title, Expense, expenses });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" : $ ");
    			t2 = text(/*total*/ ctx[1]);
    			add_location(h2, file$2, 6, 0, 107);
    			attr_dev(section, "class", "main-title");
    			add_location(section, file$2, 5, 0, 78);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 5, 2, 120);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, setName, setAmount, isEditing*/ 65574) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 114, 2, 2855);
    			attr_dev(main, "class", "content");
    			add_location(main, file, 100, 0, 2550);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*clearExpenses*/ ctx[10], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const state = { removeExpense, setModifiedExpense };
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*setId*/ 2048) {
    			$$invalidate(5, isEditing = setId ? true : false);
    		}
    	};
